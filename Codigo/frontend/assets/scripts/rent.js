...
const fetchCustomers = async () => {
    const response = await fetch('https://corporate-rent-a-car-app.onrender.com/customers');
    const data = await response.json();
    return data;
};

const fetchCompanies = async () => {
    const response = await fetch('https://corporate-rent-a-car-app.onrender.com/companies');
    const data = await response.json();
    return data;
}
...
const postRent = async () => {
    ...
    rent.value = parseFloat(rent.value.replace('R$', '').replace(/\./g, '').replace(',', '.'));
    ...
    const response = await fetch('https://corporate-rent-a-car-app.onrender.com/rents', {
        method: 'POST',
        headers: {
...
const updateRent = async () => {
    ...
    const response = await fetch(`https://corporate-rent-a-car-app.onrender.com/rents/${rentId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'userCookie': getCookie('user') || ''
